...
class I18nService:
    ...
    def __init__(self, default_language: str = None):
        ...
        Args:
            default_language: Default language code (fr or en)
        """
        self.default_language = default_language or settings.DEFAULT_LANGUAGE
        self.supported_languages = settings.SUPPORTED_LANGUAGES
        
        logger.info(f"I18n service initialized with default language: {self.default_language}")
    ...
    def translate(self, key: str, language: Optional[str] = None, **kwargs) -> str:
        ...
        Args:
            key: Translation key
            language: Target language (if None, uses default)
